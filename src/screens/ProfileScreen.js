      ...
      <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={{ paddingBottom: 40 }}>
        ...
        <View style={styles.settingsCard}>
          <SettingRow
            ...
            value={audioNarration} onToggle={setAudioNarration}
          />
          ...
          <SettingRow
            ...
            sub="Download for offline use"
            value={offlineMaps} onToggle={setOfflineMaps}
          />
        </View>
...
const styles = StyleSheet.create({
  ...
  hero: {
    ...
    height: 120, alignItems: 'center', justifyContent: 'flex-end',
    paddingBottom: 0,
  },
  avatar: {
  ...
  avatarText: {
    fontFamily: 'Syne_800ExtraBold', fontSize: 24, color: '#fff',
  },
  nameWrap: { alignItems: 'center', marginTop: 44, marginBottom: 16 },
  name: {
    fontFamily: 'Syne_800ExtraBold', fontSize: 22, color: colors.ink,
  },
  handle: {
  ...
  settingInfo: { flex: 1 },
  settingLabel: {
    fontFamily: 'DMSans_500Medium', fontSize: 14, color: colors.ink,
  },
  settingSub: {
    fontFamily: 'DMSans_400Regular', fontSize: 11,
    color: colors.muted, marginTop: 2,
  ...
  arrow: {
    fontSize: 20, color: colors.muted, fontWeight: '300',
  },
  separator: {
    height: 1, backgroundColor: colors.sandDark,
    marginHorizontal: 14,
  },
  signOutBtn: {
  ...
  signOutText: {
    fontFamily: 'Syne_700Bold', fontSize: 14, color: colors.terra,
  },
  version: {
    fontFamily: 'DMSans_400Regular', fontSize: 11,
